...
export function GridBackground() {
  return (
    <div className="h-[40rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center px-5 md:px-0">
      ...
      <div className="flex flex-col gap-y-10">
        ...
        <p className="md:text-center px-12 text-justify">
          Learn Git with me is a free and open-source platform to learn Git and
          GitHub. It is designed to be simple and easy to understand for
          beginners.
        </p>
