  ...
  return (
    <>
      <div className="text-center mt-8 md:mt-28">
        ...
        <div className="py-20 flex items-top gap-1 justify-center bg-white dark:bg-black w-full">
          <div className="flex flex-wrap justify-center px-8 w-[60%]">
...
const Card = ({ title, icon, children }) => {
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-[15rem] mx-auto p-4 relative min-h-[13rem]"
    >
