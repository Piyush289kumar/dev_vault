...
export function KeyFeature() {
    return (
        (<div
            className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full -mt-5">
            <WobbleCard
                containerClassName="col-span-1 lg:col-span-2 h-full bg-pink-800 min-h-[500px] lg:min-h-[300px] z-10"
                className="">
            ...
            <WobbleCard containerClassName="col-span-1 min-h-[300px] z-10" className="">
                <h2
            ...
            <WobbleCard
                containerClassName="col-span-1 lg:col-span-3 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]" className="">
